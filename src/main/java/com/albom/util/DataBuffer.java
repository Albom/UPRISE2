...
abstract public class DataBuffer {
	...
	public static int getDoubleWordBigEndian(byte[] buffer, int offset) {
		int b0, b1, b2, b3;
		b0 = buffer[offset + 3] >= 0 ? buffer[offset + 3] : 256 + buffer[offset + 3];
		b1 = buffer[offset + 2] >= 0 ? buffer[offset + 2] : 256 + buffer[offset + 2];
		b2 = buffer[offset + 1] >= 0 ? buffer[offset + 1] : 256 + buffer[offset + 1];
	...
	public static int getDoubleWordLittleEndian(byte[] buffer, int offset) {
		...
		b0 = buffer[offset] >= 0 ? buffer[offset] : 256 + buffer[offset];
		b1 = buffer[offset + 1] >= 0 ? buffer[offset + 1] : 256 + buffer[offset + 1];
		b2 = buffer[offset + 2] >= 0 ? buffer[offset + 2] : 256 + buffer[offset + 2];
		b3 = buffer[offset + 3] >= 0 ? buffer[offset + 3] : 256 + buffer[offset + 3];
		return b0 + b1 * 256 + b2 * 256 * 256 + b3 * 256 * 256 * 256;
	}
